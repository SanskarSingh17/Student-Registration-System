...
def Save():
     ...
     if N1=="" or C1=="Select Class" or D2=="" or Re1=="" or S1=="" or fathername=="" or mothername=="" or F1=="" or M1=="":
          ...
          try:
               img.save("Student Images/"+R1+".jpg")
          except:
...
##########top frames##############
Label(root,text="Email: 17sanskar@gmail.com",width=10,height=3,bg="#f0687c",anchor='e').pack(side=TOP,fill=X) 
...
Button(root, text="Upload",cursor="hand2" ,width=19, height=2, font="arial 12 bold", bg="lightblue",command=showimage).place(x=1000, y=370)

saveButton=Button(root, text="Save",cursor="hand2" ,width=19, height=2,font="arial 12 bold",bg="lightgreen",command=Save)
saveButton.place(x=1000, y=450)

Button(root, text="Reset" ,width=19,cursor="hand2", height=2,font="arial 12 bold",bg="lightpink",command=Clear).place(x=1000, y=530)

Button(root, text="Exit",width=19, height=2,cursor="hand2", font="arial 12 bold",bg="grey",command=Exit).place(x=1000, y=610)
